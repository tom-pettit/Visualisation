...
cmaps = ['oleron', 'vic', 'grayC', 'acton', 'oslo', 'roma']
lst = sg.Combo(cmaps, font=('Arial Bold', 14),  default_value='grayC', expand_x=True, enable_events=True,  readonly=False, key='CmapDropdown')
layout = [
